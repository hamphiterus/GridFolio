...
public class ThreadEventAmanha extends Thread {
	Context context;
	...
	public ThreadEventAmanha(String s) {
		super(s);
	}
	...
	public void run() {
		...
		try {
			...
			for (int i = 0; i < Mresult.getPropertyCount(); i++) {
				...
				AppDataEventsAmanha.getInstance().addIDEvent(Integer.parseInt(pii.getProperty(0).toString()), i);
				AppDataEventsAmanha.getInstance().addNome(pii.getProperty(3).toString(), i);
				AppDataEventsAmanha.getInstance().addDescricao(pii.getProperty(4).toString(), i);
				AppDataEventsAmanha.getInstance().addMaisinfo(pii.getProperty(5).toString(), i);
				AppDataEventsAmanha.getInstance().addIDEvent(Integer.parseInt(pii.getProperty(0).toString()), i);
				AppDataEventsAmanha.getInstance().addRefGroup(Integer.parseInt(pii.getProperty(1).toString()), i);
			}
		} catch (Exception e) {
