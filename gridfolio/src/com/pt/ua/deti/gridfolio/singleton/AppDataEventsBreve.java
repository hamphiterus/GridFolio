...
public class AppDataEventsBreve {
	private static AppDataEventsBreve _instance;
	...
	private AppDataEventsBreve() {

	}

	public static AppDataEventsBreve getInstance() {
		if (_instance == null) {
			_instance = new AppDataEventsBreve();
		}
		return _instance;
	}
