...
public class AppDataEventsHoje {

	private static AppDataEventsHoje _instance;
	...
	private AppDataEventsHoje() {

	}

	public static AppDataEventsHoje getInstance() {
		if (_instance == null) {
			_instance = new AppDataEventsHoje();
		}
		return _instance;
	}
